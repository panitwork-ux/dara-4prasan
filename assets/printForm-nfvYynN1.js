import{R as $,f,t as v}from"./index-BYz9Dve0.js";const x=i=>{if(!i)return"...........................";try{return f(new Date(i),"d MMMM yyyy",{locale:v})}catch{return i}},u=i=>{if(!i)return"........../........../...........";try{return f(new Date(i),"d/M/yyyy",{locale:v})}catch{return i}};function S(i,l=null){var p,o,r;const d=i.records||[],h=i.problems||[],c=i.helpDone||[],g=i.remaining||[],m=i.suggestions||[],a=l?`<img src="${l}" style="width:56px;height:56px;object-fit:contain;" />`:'<div style="width:56px;height:56px;background:#1d4ed8;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;font-weight:800;">ด</div>',y=d.length>0?d.map((s,t)=>`
        <tr>
