...
function roleDesc(role) {
  return {
    ...
    head_kindergarten: 'เซ็นรับรองเอกสาร 2 ติดตามผล',
    head_primary_low:  'เซ็นรับรองเอกสาร 2 ติดตามผล',
    head_primary_high: 'เซ็นรับรองเอกสาร 2 ติดตามผล',
    head_junior:       'เซ็นรับรองเอกสาร 2 ติดตามผล',
    ...
    guidance:          'สร้างเอกสาร 3 ดูแลนักเรียน บันทึกผลติดตาม',
    discipline:        'สร้างเอกสาร 3 ดูแลนักเรียน บันทึกผลติดตาม',
    nurse:             'สร้างเอกสาร 3 ดูแลนักเรียน บันทึกผลติดตาม',
    religious:         'สร้างเอกสาร 3 ดูแลนักเรียน บันทึกผลติดตาม',
  }[role] || ''
}
